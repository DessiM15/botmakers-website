// SPEC: Google Calendar Integration > Email > 4h Reminder

interface MeetingReminder4hData {
  name: string;
  time: string;
  meetingLink: string | null;
}

export function meetingReminder4h(
  data: MeetingReminder4hData
...
<div style="max-width:600px;margin:0 auto;padding:24px">
  ...
  <div style="background:#fff;padding:32px;border:1px solid #e4e4e7;border-top:none">
    ...
    <p style="margin:0 0 16px;font-size:15px;line-height:1.7;color:#3f3f46">
      Your demo with BotMakers starts at <strong>${data.time} (Central Time)</strong>. See you soon!
    </p>
    ${data.meetingLink ? `
