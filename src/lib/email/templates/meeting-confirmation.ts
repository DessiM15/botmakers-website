// SPEC: Google Calendar Integration > Email > Meeting Confirmation
// Sent to prospect when a booking is created
...
<div style="max-width:600px;margin:0 auto;padding:24px">
  ...
  <div style="background:#fff;padding:32px;border:1px solid #e4e4e7;border-top:none">
    ...
    <p style="margin:0 0 16px;font-size:15px;line-height:1.7;color:#3f3f46">
      Your discovery call with BotMakers is confirmed. We're looking forward to learning about your project!
    </p>
    <div style="margin:20px 0;padding:20px;background:#f0fdf4;border-left:4px solid #03FF00;border-radius:4px">
      <p style="margin:0 0 8px;font-size:14px;font-weight:600;color:#18181b">Meeting Details</p>
      <p style="margin:0 0 4px;font-size:14px;color:#3f3f46"><strong>Date:</strong> ${data.date}</p>
      <p style="margin:0 0 4px;font-size:14px;color:#3f3f46"><strong>Time:</strong> ${data.time} (Central Time)</p>
    </div>
    ${data.meetingLink ? `
    ...
    <p style="margin:16px 0 0;font-size:13px;color:#a1a1aa">
      We'll send you a reminder before the meeting. If you need to reschedule, just reply to this email.
    </p>
  </div>
  <div style="padding:20px 32px;background:#f9fafb;border:1px solid #e4e4e7;border-top:none;border-radius:0 0 8px 8px;text-align:center">
    <p style="margin:0;font-size:12px;color:#a1a1aa">BotMakers Inc. &bull; Katy, TX &bull; <a href="https://botmakers.ai" style="color:#1E40AF">botmakers.ai</a></p>
  </div>
</div>
</body></html>`,
  };
