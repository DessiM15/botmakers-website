// SPEC: Booking Widget > Calendar Grid (dark-themed month picker)
// DEP-MAP: Booking Widget > CLIENT > BookingCalendar
"use client";
...
export function BookingCalendar({
  ...
  // Build grid: offset for first day + all days in month
  ...
  const canGoPrev = useMemo(() => {
    ...
    return lastDayPrev >= today && prevMonth >= new Date(today.getFullYear(), today.getMonth(), 1);
  }, [year, month, today]);
